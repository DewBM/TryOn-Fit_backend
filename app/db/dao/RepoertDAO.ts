...
console.log("3month")
  try {
    return await db
  .select({
    supplier: productsTable.supplier, // Fetch supplier ID
...
console.log("3month")
  ...
  .where(
    and(
      eq(ordersTable.order_status, "Delivered"), // Filter by order status // Filter by month
      eq(sql<number>`EXTRACT(YEAR FROM ${ordersTable.order_date})`, year) // Filter by year
    )
  )
  .groupBy(productsTable.supplier); // Group by supplier ID
...
export async function getAllSuppliersCost(filterDate : filterDateType) {
  const startDate = new Date(filterDate.startDate); // Start date for filtering
  const endDate = new Date(filterDate.endDate); // End date for filtering
  // console.log(startDate,endDate);
...
export async function getmonthyCost(month: string, year: string,) {
  // const month = filterDate;
console.log("3month")
  try {
    return await db
...
export async function getyearlyCost( year: string,) {
  // const month = filterDate;
console.log("3month")
  try {
    return await db
...
export async function getAllSuppliersProfit(filterDate : filterDateType) {
  const startDate = new Date(filterDate.startDate); // Start date for filtering
  const endDate = new Date(filterDate.endDate); // End date for filtering
  // console.log(startDate,endDate);
...
export async function getmonthyProfit(month: string, year: string,) {
  // const month = filterDate;
console.log("3month")
  try {
    return await db
...
export async function getyearlyProfit( year: string,) {
  // const month = filterDate;
console.log("3month")
  try {
    return await db
